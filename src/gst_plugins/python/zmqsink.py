...
from vipipe.transport.gstreamer import BufferMessage, BufferMetaMessage, CapsMessage, GstWriter
...
class GstZeroMQSink(GstBase.BaseSink):
    ...
    def do_render(self, buffer):
        ...
        try:
            ...
            logger.debug("Отправили буфер, размер: %d", len(map_info.data))
